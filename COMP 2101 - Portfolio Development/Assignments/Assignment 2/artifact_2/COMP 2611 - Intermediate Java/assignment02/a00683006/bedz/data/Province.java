...
/**
 * An enum for provinces that sets the province properly
 * based on the two-letter initial used for each province.
 * Obviously we do not care about non-Canadians. ;-)
 * @author Sam Scirka
 * 
 */
