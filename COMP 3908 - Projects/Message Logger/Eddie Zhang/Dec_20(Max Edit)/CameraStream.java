...
import net.rim.device.api.util.StringUtilities;
 ...
 /**
  * CameraStream is the camera application of the Trusterra Memo Logger.
  * It is capable of taking multiple pictures, viewing and saving them.
  */
 class CameraStream extends MainScreen {
    /**
    ...
    private MediaController mc_;
      ...
      */
    CameraStream(MediaController mc) {
        this.mc_ = mc;
        /**
     ...
     */
    private void createGUI(MediaController mc) {
        this.mc_ = mc;
        ...
        cancelButton_.setChangeListener(new FieldChangeListener() {
            /**
             * When the "Cancel" button is press, pop the screen to
