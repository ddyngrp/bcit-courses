...
public:
	...
	DPlaya() : x_(0), y_(0), w_(35), h_(35), xVel(0), yVel(0), bombPower(2), DPlayaID_(-1), bombPower_(4), connected_(false), alive_(true), image_(IMG_Load("default.png")){}
	...
	void killPlayer(){alive_ = false; x_ = -70; y_ = -70;}
