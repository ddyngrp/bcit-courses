...
BOOL InitApp(HINSTANCE hInst, int nCmdShow) {
	...
	// Setup the program's terminal child window class
	wc.lpfnWndProc		= (WNDPROC)TermChildProc;
	wc.hInstance		= hInst;
	wc.hCursor			= LoadCursor(NULL, IDC_IBEAM);
	wc.hbrBackground	= (HBRUSH)(COLOR_WINDOW + 1);
	wc.lpszClassName	= "TermChildClass";
	...
	ghWndMain = CreateWindow(szAppName, "Terminal Emulator",
		WS_OVERLAPPEDWINDOW,
