...
<html>
    <head>
        ...
        <title><%=application.getInitParameter("title")%> - Team Schedules</title>
            ...
            <div id="content" style="width:800px">
                ...
                <div id="contenttext">
                    <%
                        ...
                        String xml_path = "/WEB-INF/data/Odense_BK_roster.xml";
                        String xsl_path = "/WEB-INF/data/team_roster.xsl";

                        if (request.getParameter("team").equals("1")) {
                            xml_path = "/WEB-INF/data/Odense_BK_roster.xml";
                            xsl_path = "/WEB-INF/data/team_roster.xsl";
                        }
                        else if (request.getParameter("team").equals("2")) {
                            xml_path = "/WEB-INF/data/AC_Horsens_roster.xml";
                            xsl_path = "/WEB-INF/data/team_roster.xsl";
                        }
