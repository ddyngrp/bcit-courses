...
class Menu extends MainScreen {
    ...
    public static final int SAVE        = 2005;
    public static final int CANCEL      = 2006;
   // public static final int LI = 3;
    public static final String TEXT_BTNLABEL = "TEXT";
    ...
    public static final String SAVE_BTNLABEL = "SAVE";
    ...
    void initialScreen()
    {
      ...
      //  titleManager.add(subtitle);
       ...
       //buttons
        ...
        textButton = new ButtonField(TEXT_BTNLABEL);
        textButton.setChangeListener(new ButtonListener());
        ...
        saveButton = new ButtonField(SAVE_BTNLABEL);
