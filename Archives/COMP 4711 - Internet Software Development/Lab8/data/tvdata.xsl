    ...
    <xsl:template match="/">
        <html>
            ...
            <body>
                ...
                <xsl:variable name="has-match-selected">
                    <xsl:for-each select="tv/programme">
                        <xsl:if test=
                            "
                                ((number(substring(@start, 9, 2)) >= 8)
                                and not
                                (number(substring(@start, 9, 2)) > 11))
                            or
                                ((number(substring(@stop, 9, 2)) >= 8)
                                and not
                                (number(substring(@stop, 9, 2)) > 11))
                            ">
                ...
                <xsl:variable name="has-match-inclusive">
                    <xsl:for-each select="tv/programme">
                        <xsl:if test=
                            "
                                ((number(substring(@start, 9, 2)) >= 8)
                ...
                <table border="1">
                    ...
                    <tr>
                        ...
                        <td>
                            <xsl:value-of select="sum(exsl:node-set($has-match-selected)/value)" />
                        </td>
                        <td>
                            <xsl:value-of select="sum(exsl:node-set($has-match-inclusive)/value)" />
                        </td>
                    </tr>
                </table>
