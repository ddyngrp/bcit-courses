...
public class CameraStream extends UiApplication {
        ...
        public void run() {
            try {
                ...
                if(vc!=null && isViewfinderVisible) {
                    ...
                    //final byte[] imageBytes = vc.getSnapshot("encoding=jpeg width=320 height=240");
    ...
    public CameraStream() {           
        ...
        String[] choices = {"SuperFine 1600x1200", "Fine 1600x1200", "Normal 1600x1200",
            "SuperFine 1024x768", "Fine 1024x768", "Normal 1024x768",
            "SuperFine 640x480", "Fine 640x480", "Normal 640x480"};    
