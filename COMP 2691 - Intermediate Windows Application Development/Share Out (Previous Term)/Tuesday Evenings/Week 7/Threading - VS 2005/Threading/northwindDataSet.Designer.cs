...
namespace Threading.northwindDataSetTableAdapters {
...
SELECT CategoryID, CategoryName, Description, Picture FROM Categories WHERE (CategoryID = @CategoryID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Threading.Properties.Settings.Default.northwindConnectionString;
        }
...
SELECT CustomerID, CustomerTypeID FROM CustomerCustomerDemo WHERE (CustomerID = @CustomerID) AND (CustomerTypeID = @CustomerTypeID)";
        ...
        private void InitConnection() {
            this._connection = new global::System.Data.SqlClient.SqlConnection();
            this._connection.ConnectionString = global::Threading.Properties.Settings.Default.northwindConnectionString1;
        }
