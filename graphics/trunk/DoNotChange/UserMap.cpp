...
bool UserMap::update_map(int **new_map, const int height, const int width)
{
	int i, j;
...
void UserMap::set_images(SDL_Surface *new_image, const int numImages)
{
	SDL_Surface *temp;
...
bool UserMap::draw_map(SDL_Surface *screen)
{
