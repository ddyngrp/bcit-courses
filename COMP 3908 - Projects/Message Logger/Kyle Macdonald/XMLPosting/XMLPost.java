...
public class XMLPost {
     ...
     */
    String postViaHttpConnection(String postData) throws IOException {
    ...
    /**
     * Used to test xml posting.
     * @param args command line argument
     */
    public static void main(String args[]) {
        String hostname = "http://mlogger.trollop.org:3141";
        String path = "/MLogger/MLService.asmx";

        XMLPost test = new XMLPost(hostname + path + "?op=UserLogin");
        String str;
        try {
            str = test.postViaHttpConnection(new XML_Login_Request("kyle", "hello").toString());
            System.err.println(str);
        } catch (IOException e) {
               System.err.println("you fuct up");
        }
    }
} 
